...
ACPI_BASE_PATH="/sys/devices/platform/80860F41:06"
ACPI_STATUS="$ACPI_BASE_PATH/firmware_node/status"
PCI_BASE_PATH="/sys/devices/pci0000:00/0000:00:18.7"
...
if [ -z "$I2CBUS" ]; then
	if [ -d $PCI_BASE_PATH ]; then
		...
		echo "ERROR: I2C6 bus not found"
		exit 1
	fi
fi

echo "Found I2C6 Bus: $I2CBUS"
